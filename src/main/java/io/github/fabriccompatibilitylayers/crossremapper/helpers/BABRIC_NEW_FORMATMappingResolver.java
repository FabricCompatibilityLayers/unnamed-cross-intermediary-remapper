...
public class BABRIC_NEW_FORMATMappingResolver extends BaseMappingResolver {
    private static final String CONTEXT_ID = "cross-intermediary-" + FabricVariants.BABRIC_NEW_FORMAT;
