...
public class LEGACY_FABRIC_V1MappingResolver extends BaseMappingResolver {
    private static final String CONTEXT_ID = "cross-intermediary-" + FabricVariants.LEGACY_FABRIC_V1;
